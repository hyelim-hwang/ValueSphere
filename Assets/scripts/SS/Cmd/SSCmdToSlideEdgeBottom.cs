...
namespace SS.Cmd {
    public class SSCmdToSlideEdgeBottom : XLoggableCmd {
        //fields
        Vector2 mPrevPt = SSUtil.VECTOR2_NAN;
        Vector2 mCurPt = SSUtil.VECTOR2_NAN;

        //private constructor
        private SSCmdToSlideEdgeBottom(XApp app) : base(app) {}

        //static method to construct and execute this command
        public static bool execute(XApp app) {
            SSCmdToSlideEdgeBottom cmd = new SSCmdToSlideEdgeBottom(app);
            return cmd.execute();
        }
        ...
        protected override bool defineCmd() {
            ...
            Vector3 edgeBottom = stick.getEdgeBottom();
            edgeBottom +=  new Vector3(0, offset.y, 0);
            stick.setEdgeBottom(edgeBottom);
        ...
        protected override XJson createLogData() {
            ...
            data.addMember("slideEdgeBottom", this.GetType().Name);
            return data;
        }
    }
}