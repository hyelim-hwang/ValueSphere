...
namespace SS.Cmd {
    public class SSCmdToCallRobotArm : XLoggableCmd {
        //fields

        //private constructor
        private SSCmdToCallRobotArm(XApp app) : base(app) {}

        //static method to construct and execute this command
        public static bool execute(XApp app) {
            SSCmdToCallRobotArm cmd = new SSCmdToCallRobotArm(app);
            return cmd.execute();
        }

        protected override bool defineCmd() {
            return this.readFile(
                "C:\\Users\\sketc\\Desktop\\SS3dSaveFiles\\robot.SS3d");
        ...
        private bool readFile(string filePath) {
            ...
            try {
                ...
                // change the underlay status
                SS.getHairdryerUnderlay().getGameObject().SetActive(false);
                SS.getRobotUnderlay().getGameObject().SetActive(true);
        ...
        protected override XJson createLogData() {
            ...
            data.addMember("callRobotArm", this.GetType().Name);
            return data;
        }
    }
}