...
//         public class UpdateSubStickScene : SSScene {
//             //singleton pattern
//             private static UpdateSubStickScene mSingleton = null;
//             public static UpdateSubStickScene getSingleton() {
//                 Debug.Assert(
//                     UpdateSubStickScene.mSingleton != null);
//                 return UpdateSubStickScene.mSingleton;
//             }
//             public static UpdateSubStickScene createSingleton(
//                 XScenario scenario) {
//                 Debug.Assert(
//                     UpdateSubStickScene.mSingleton == null);
//                 UpdateSubStickScene.mSingleton =
//                     new UpdateSubStickScene(scenario);
//                 return UpdateSubStickScene.mSingleton;
//             }

//             private UpdateSubStickScene(XScenario scenario) :
//                 base(scenario) {}
...
//                 SSApp ss = (SSApp)this.mScenario.getApp();
//                 SSCmdToUpdateSubStick.execute(ss);
//             }
