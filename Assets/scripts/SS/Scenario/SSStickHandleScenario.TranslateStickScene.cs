...
namespace SS.Scenario {
    public partial class SSStickHandleScenario : XScenario {
        public class TranslateStickScene : SSScene {
            //singleton pattern
            private static TranslateStickScene mSingleton = null;
            public static TranslateStickScene getSingleton() {
                Debug.Assert(TranslateStickScene.mSingleton != null);
                return TranslateStickScene.mSingleton;
            }
            public static TranslateStickScene createSingleton(XScenario scenario) {
                Debug.Assert(TranslateStickScene.mSingleton == null);
                TranslateStickScene.mSingleton = new TranslateStickScene(scenario);
                return TranslateStickScene.mSingleton;
            }

            private TranslateStickScene(XScenario scenario) : base(scenario) {}
