...
namespace SS.Scenario {
    public partial class SSSperspectiveDecideScenario : XScenario {
        public class ChangeFOVScene : SSScene {
            //singleton pattern
            private static ChangeFOVScene mSingleton = null;
            public static ChangeFOVScene getSingleton() {
                Debug.Assert(ChangeFOVScene.mSingleton != null);
                return ChangeFOVScene.mSingleton;
            }
            public static ChangeFOVScene createSingleton(XScenario scenario) {
                Debug.Assert(ChangeFOVScene.mSingleton == null);
                ChangeFOVScene.mSingleton = new ChangeFOVScene(scenario);
                return ChangeFOVScene.mSingleton;
            }

            private ChangeFOVScene(XScenario scenario) : base(scenario) {}
